                ...
                <div className="flexrow preset">
                    <div onClick={() => handlePreset(0)}>
                        <Preset
                            ...
                            presetImg={small}
                            style={preset1 ? "flexrow preset-card on" : "flexrow preset-card "}
                        />
                    </div>
                    <div onClick={() => handlePreset(1)}>
                        <Preset
                            ...
                            presetImg={large}
                            style={preset2 ? "flexrow preset-card on" : "flexrow preset-card "}
                        />
                    </div>
                    <div onClick={() => handlePreset(2)}>
                        <Preset
                            ...
                            presetImg={rural}
                            style={preset3 ? "flexrow preset-card on" : "flexrow preset-card "}
                        />
                    </div>
                </div>
            </div>
            ...
            <div className="section-1">
                <h3>
                    ...
                    <Tooltip
                        ...
                        html={
                            <p style={{ fontFamily: "rubik", margin: "0.1em" }}>
                                Only add appliances not shown in the section
                                above.
                            </p>
                        }>
                        <IoIosInformationCircleOutline />
