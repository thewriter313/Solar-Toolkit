...
const FaqData = [
  {
    ...
    answer: (
      <div>
        ...
        <p>
          A Solar DC panel generates DC voltage from the Solar cells in the
          Solar modules which is then connected to charge the batteries through
          a Solar charge controller. A string inverter is used in this
          arrangement to convert the DC current to AC so as to supply the AC
          loads.{" "}
        </p>
        <h3>AC Solar Arrays</h3>
        <p>
          These are Solar panels that have a Micro-Inverter connected at the
          back that immediately converts the DC current produced by the panel
          into AC current. In AC Solar panels, the AC current produced will have
          to be converted back to DC current using a rectifier in order to
      ...
      <div>
        ...
        >
          ...
          <li>
            ...
            not affect the rest of the panels which enables them to continue
          ...
          <li>
            ...
            the panels in the array, microinverters monitor panels individually
            hence a faulty panel can be quickly and easily identified
          </li>
          <br />
          <li>
            ...
            can continue to provide power as the issue is being resolved
          </li>
          <br />
          <li>
            ...
            inverter this problem will not be encountered and hence other panels
            can be added
          </li>
          <br />
          <li>
            ...
            underperforming in most cases. This isn't a problem that is
            encountered in AC Solar panels as the micro inverters enable the
            individual panels to produce AC power
          </li>
          <br />
        </ul>
      </div>
